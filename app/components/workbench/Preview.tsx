...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('bolt:refresh-preview', handler);

    return () => window.removeEventListener('bolt:refresh-preview', handler);
  }, [reloadPreview]);
          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                />
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-bolt-elements-bg-depth-1 rounded-xl shadow-2xl border border-bolt-elements-borderColor overflow-hidden">
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-bolt-elements-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-bolt-elements-bg-depth-3 bg-bolt-elements-bg-depth-1"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-bolt-elements-textTertiary group-hover:text-purple-700 dark:group-hover:text-purple-700 transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        ...
                        <span className="text-xs text-bolt-elements-textTertiary group-hover:text-purple-700 dark:group-hover:text-purple-700 transition-colors duration-200">
