 ...
 *
 * Integrates the Bolt Agent Mode with the chat flow.
 ...
 *
 * When **all** tool calls in the batch are read-only (`bolt_read_file`,
 * `bolt_list_directory`, `bolt_search_code`, `bolt_get_errors`), they
