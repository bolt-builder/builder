...
export type WorkbenchViewType = 'code' | 'diff' | 'preview' | 'browser' | 'versions';
...
export class WorkbenchStore {
   ...
   * Each item is checked for a `bolt_event` wrapper key, validated against
